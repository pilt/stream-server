...
{
        public:
                StreamServer(int port = 8544) throw(StreamServerError);
                ~StreamServer();
                const int port;
                ...
                void addMPEG(char const* file, char const* name)
                        throw(StreamServerRunError);
                void run() throw(StreamServerRunError);
                void stop() throw(StreamServerRunError);
                void remove(char const* name) throw(StreamServerRunError);
